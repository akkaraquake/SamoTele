// Переход в "Содержимое раздела" после нажатия по названию в таблице разделов в "Список разделов"
function show_section_content(section_name) {
    ...
    // Отображаем ссылку для возвращения в список разделов
    document.querySelector('.section_name a').removeAttribute('hidden');
